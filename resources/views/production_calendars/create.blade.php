...
@section('title', 'Create Production Calendar')
@section('page-title', 'Create New Production Calendar')

@section('content')
    <section class="section">
        <form action="{{ route('production_calendars.store') }}" method="POST">
            @csrf
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="activity"
                                    ...
                                    value="{{ old('activity') }}" placeholder="e.g. Christmas Holiday, Ramadan Break"
                                    required>
                                @error('activity')
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="day_type" class="form-select @error('day_type') is-invalid @enderror"
                                            ...
                                            <option value="holiday" {{ old('day_type') == 'holiday' ? 'selected' : '' }}>
                                                Holiday</option>
                                            <option value="mass leave"
                                                {{ old('day_type') == 'mass leave' ? 'selected' : '' }}>Mass Leave</option>
                                        </select>
                                        @error('day_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="card-footer text-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Create Calendar
                            </button>
                        </div>
                    </div>
                </div>
