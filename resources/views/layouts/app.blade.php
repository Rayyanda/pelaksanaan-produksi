            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ route('dashboard') }}">WIP Tracking</a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @if (auth()->user()->isAdmin() || auth()->user()->isSupervisor())
                            <li class="sidebar-item {{ request()->routeIs('part-internals.*') ? 'active' : '' }} ">
                                <a href="{{ route('part-internals.index') }}" class='sidebar-link'>
                        ...
                        @if (auth()->user()->isAdmin() || auth()->user()->isSupervisor() || auth()->user()->isPPC())
                            ...
                            <li class="sidebar-item {{ request()->routeIs('wip-trackings.*') ? 'active' : '' }} ">
                                <a href="{{ route('wip-trackings.index') }}" class='sidebar-link'>
                                    <i class="bi bi-clipboard-data"></i>
                                    <span>WIP Trackings</span>
                                </a>
                            </li>
                        @endif
                                ...
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            ...
                                            <p class="mb-0 text-sm text-gray-600">{{ ucfirst(auth()->user()->role) }}{{ auth()->user()->division ? ' - ' . ucfirst(auth()->user()->division->name) : '' }}</p>
                                        </div>
                ...
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                            by <a href="si.unsada.ac.id">Dhihya Rayyanda</a></p>
                    </div>
                </div>
            </footer>
        </div>
