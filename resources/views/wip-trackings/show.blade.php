                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <div class="mt-2">
                            ...
                            @elseif($wipTracking->status == 'in_progress')
                                <span class="badge bg-primary" style="font-size: 1rem; padding: 0.5rem 1rem;">In
                                    Progress</span>
                            @else
                                <span class="badge bg-success"
                                    style="font-size: 1rem; padding: 0.5rem 1rem;">Completed</span>
                            @endif
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($wipTracking->partOperation->division)
                                        <span
                                            class="badge bg-info">{{ $wipTracking->partOperation->division->name }}</span>
                                    @else
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    @if ($wipTracking->started_at)
                                        ...
                                        <br><small
                                            class="text-muted">{{ $wipTracking->started_at->diffForHumans() }}</small>
                                    @else
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($wipTracking->finished_at)
                                        ...
                                        <br><small
                                            class="text-muted">{{ $wipTracking->finished_at->diffForHumans() }}</small>
                                    @else
                    ...
                    @if ($wipTracking->batch)
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('batches.show', $wipTracking->batch->id) }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if ($wipTracking->status != 'completed')
                                <button class="btn btn-outline-secondary btn-sm mt-3" data-bs-toggle="modal"
                                    data-bs-target="#notesModal">
                                    <i class="bi bi-pencil"></i>
                                    {{ $wipTracking->operation_notes ? 'Edit Notes' : 'Add Notes' }}
                                </button>
                            @endif
                        </div>
                    </div>
                                    ...
                                    @elseif($wipTracking->status == 'in_progress')
                                        ...
                                        @else
                                            <button class="btn btn-success"
                                                onclick="completeWip({{ $wipTracking->id }})">
                        ...
                        <div class="card-body">
                            ...
                            @if ($wipTracking->status == 'in_progress' && $wipTracking->started_at)
                                <div class="mb-3">
                                    ...
                                    <strong
                                        class="text-primary">{{ $wipTracking->started_at->diffForHumans(null, true) }}</strong>
                                </div>
                            @endif
                        </div>
                    </div>
