                    ...
                    <form action="{{ route('wip-trackings.index') }}" method="GET" class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="step" class="form-select">
                                ...
                                <option value="quality_check" {{ request('step') == 'quality_check' ? 'selected' : '' }}>
                                    Quality Check</option>
                                <option value="process" {{ request('step') == 'process' ? 'selected' : '' }}>Process
                                </option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <table class="table table-hover" id="table1">
                            ...
                            <tbody>
                                @forelse($wipTrackings as $wip)
                                    <tr class="{{ $wip->is_urgent ? 'bg-warning' : '' }}">
                                        <td>
                                            <div>
                                        ...
                                        <td>
                                            <span class="badge bg-secondary">
                                                DOP #{{ $wip->partOperation->route_order }}
                                            </span>
                                            @if ($wip->partOperation->division)
                                                <br><small
                                                    class="text-muted">{{ $wip->partOperation->division->name }}</small>
                                            @endif
                                            @if ($wip->partOperation->area)
                                                <br><small
                                                    class="text-muted">{{ $wip->partOperation->area->name }}</small>
                                            @endif
                                        </td>
                                        <td>
                                            @if ($wip->batch)
                                            ...
                                            <div style="min-width: 200px;">
                                                ...
                                                @elseif($wip->started_at)
                                                    <small class="text-primary">
                                                        ...
                                                        Started:
                                                        {{ \Carbon\Carbon::parse($wip->started_at)->format('d M Y') }}
                                                    </small>
                                                    <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($summary as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <strong>{{ number_format($item['total_qty']) }}</strong>
                                            </td>
                                            <td class="text-center">
