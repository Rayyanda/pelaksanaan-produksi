                ...
                <form action="{{ route('users.index') }}" method="GET" class="row g-3">
                    <div class="col-md-3">
                        ...
                        <select name="role" class="form-select">
                            ...
                            <option value="supervisor produksi" {{ request('role') == 'supervisor produksi' ? 'selected' : '' }}>Supervisor Produksi</option>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            @if($user->email_verified_at)
                                                <i class="bi bi-patch-check-fill text-success" data-bs-toggle="tooltip" title="Email Verified"></i>
                                            @endif
                                        </div>
                                    </div>
                                </td>
