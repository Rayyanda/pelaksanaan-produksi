                            ...
                            <form action="{{ route('po-productions.update', $poProduction->id) }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="po_number" value="{{ old('po_number', $poProduction->po_number) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                name="quantity" value="{{ old('quantity', $poProduction->quantity) }}"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('po_snapshot') is-invalid @enderror" id="po_snapshot" name="po_snapshot"
                                                rows="10" placeholder='{"item": "Product Name", "vendor": "Vendor Name", "price": 10000}'
                                            ...
                                            @error('po_snapshot')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Snapshot data from external PO module in JSON format
                                                (optional)</small>
                                            <div class="mt-2">
                                ...
                                <div class="form-group mb-3">
                                    <div class="alert alert-info">
                                        ...
                                        <strong>Note:</strong> The PO snapshot will store a copy of the PO data from the
                                        external module.
                        ...
                        <div class="card-body">
                            ...
                            @if ($poProduction->deleted_at)
                                <div class="mb-3">
                                    ...
                                    <strong
                                        class="text-danger">{{ $poProduction->deleted_at->format('d M Y, H:i') }}</strong>
                                </div>
                            @endif
                                ...
                                <div class="mb-3">
                                    ...
                                    @php
                                        $daysLeft = \Carbon\Carbon::now()->diffInDays(
                                            \Carbon\Carbon::parse($poProduction->due_date),
                                            false,
                                        );
                                    @endphp
                                    @if ($daysLeft < 0)
...
@push('scripts')
    ...
    <script>
        ...
        function validateJSON() {
            ...
            if (!value) {
                statusDiv.innerHTML =
                    '<div class="alert alert-warning"><i class="bi bi-exclamation-triangle"></i> JSON is empty</div>';
                return false;
            }
            ...
            try {
                JSON.parse(value);
                statusDiv.innerHTML =
                    '<div class="alert alert-success"><i class="bi bi-check-circle"></i> Valid JSON format!</div>';
                return true;
            } catch (e) {
                statusDiv.innerHTML = '<div class="alert alert-danger"><i class="bi bi-x-circle"></i> Invalid JSON: ' + e
                    .message + '</div>';
                return false;
            }
        }
        ...
        function formatJSON() {
            ...
            try {
                ...
                statusDiv.innerHTML =
                    '<div class="alert alert-success"><i class="bi bi-check-circle"></i> JSON formatted successfully!</div>';
            } catch (e) {
                statusDiv.innerHTML = '<div class="alert alert-danger"><i class="bi bi-x-circle"></i> Cannot format: ' + e
                    .message + '</div>';
            }
        }
        ...
        function refreshSnapshot() {
            ...
            if (!poSource) {
                statusDiv.innerHTML =
                    '<div class="alert alert-warning"><i class="bi bi-exclamation-triangle"></i> PO Source URL is empty</div>';
                return;
            }

            statusDiv.innerHTML =
                '<div class="alert alert-info"><i class="bi bi-arrow-clockwise"></i> Fetching data from source...</div>';
            ...
            fetch(poSource)
                ...
                .then(data => {
                    ...
                    statusDiv.innerHTML =
                        '<div class="alert alert-success"><i class="bi bi-check-circle"></i> Snapshot refreshed successfully!</div>';
                })
                .catch(error => {
                    statusDiv.innerHTML =
                        '<div class="alert alert-danger"><i class="bi bi-x-circle"></i> Failed to fetch: ' + error
                        .message + '</div>';
                });
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            observer.observe(document.getElementById('jsonStatus'), {
                childList: true
            });
        });
    </script>
