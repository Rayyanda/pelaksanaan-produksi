...
@section('content')
    <div class="container-fluid">
        ...
        @else
            {{-- go to production shcedules --}}
            <a href="{{ route('production-schedules.index') }}" class="btn btn-primary btn-sm">
                <i class="bi bi-calendar-check-fill"></i> Production Schedules
            </a>
            <!-- Filter Section -->
            <div class="card mb-4">
                    ...
                    <form method="GET" class="row g-3 align-items-end">
                            ...
                            <select name="part_id" class="form-select form-select-sm">
                                ...
                                @foreach (\App\Models\PartInternal::all() as $part)
                                    <option value="{{ $part->id }}"
                                        {{ request('part_id') == $part->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status" class="form-select form-select-sm">
                                ...
                                <option value="planned" {{ request('status') == 'planned' ? 'selected' : '' }}>Planned
                                </option>
                    ...
                    <div style="overflow-x: auto; min-width: 100%;">
                        <div style="min-width: 1400px;">
                            @php
                                ...
                                while ($currentMonth->lte($maxDate) && $monthLimit < 36) {
                                    // Max 36 months
                                ...
                                <div class="d-flex align-items-start mb-4 batch-row"
                                    ...
                                    <div style="width: 250px; flex-shrink: 0;" class="pe-3">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <button class="btn btn-sm btn-link text-secondary p-0" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#process-{{ $batch->id }}">
                                    ...
                                    <div class="flex-fill">
                                        ...
                                        <div class="position-relative"
                                            style="height: 50px; background-color: #f8f9fa; border-radius: 6px;">
                                            <!-- Main Bar -->
                                            <div class="position-absolute bg-{{ $barColor }} rounded shadow-sm timeline-bar"
                                                ...
                                                <div
                                                    class="d-flex align-items-center justify-content-center h-100 text-white small px-2">
                                            ...
                                            <div class="card card-body bg-light p-2">
                                                @foreach ($batch->productionSchedules as $schedule)
                                                    @php
                                                        ...
                                                        $processStart = $minDate->diffInDays(
                                                            $schedule->plan_start_date,
                                                        );
                                                        $processDuration =
                                                            $schedule->plan_start_date->diffInDays(
                                                                $schedule->plan_end_date,
                                                            ) + 1;
                                                        $processLeftPercent =
                                                            $totalDays > 0 ? ($processStart / $totalDays) * 100 : 0;
                                                        $processWidthPercent =
                                                            $totalDays > 0 ? ($processDuration / $totalDays) * 100 : 0;
                                                        ...
                                                        $processBarColor =
                                                            $processStatusColors[$schedule->status] ?? 'secondary';
                                                    @endphp

                                                    <div class="d-flex align-items-center mb-1" style="height: 28px;">
                                                        <div style="width: 150px;"
                                                            class="small text-muted pe-2 text-truncate">
                                                            {{ $schedule->getProcessLabel() }}
                                                        </div>
                                                        <div class="position-relative flex-fill"
                                                            style="height: 24px; background-color: #e9ecef; border-radius: 4px;">
                            ...
                            <div class="mt-5 pt-4 border-top">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                            <div style="width: 20px; height: 20px;" class="bg-success rounded me-2"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('[data-bs-toggle="collapse"]').forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    setTimeout(function() {
                        const isShown = document.querySelector(target).classList.contains(
                            'show');
                        if (isShown) {
